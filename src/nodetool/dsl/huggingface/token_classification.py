...
class TokenClassification(GraphNode):
    ...
    model: types.HFTokenClassification | GraphNode | tuple[GraphNode, str] = Field(default=types.HFTokenClassification(type='hf.token_classification', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model ID to use for token classification')
