...
class QuestionAnswering(GraphNode):
    ...
    model: types.HFQuestionAnswering | GraphNode | tuple[GraphNode, str] = Field(default=types.HFQuestionAnswering(type='hf.question_answering', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model ID to use for question answering')
...
class TableQuestionAnswering(GraphNode):
    ...
    model: types.HFTableQuestionAnswering | GraphNode | tuple[GraphNode, str] = Field(default=types.HFTableQuestionAnswering(type='hf.table_question_answering', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model ID to use for table question answering')
    dataframe: types.DataframeRef | GraphNode | tuple[GraphNode, str] = Field(default=types.DataframeRef(type='dataframe', uri='', asset_id=None, data=None, columns=None), description='The input table to query')
