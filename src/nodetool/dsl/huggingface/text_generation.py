...
class TextGeneration(GraphNode):
    ...
    model: types.HFTextGeneration | GraphNode | tuple[GraphNode, str] = Field(default=types.HFTextGeneration(type='hf.text_generation', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model ID to use for the text generation')
