...
class Kandinsky3Img2Img(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The input image to transform')
...
class RealESRGANNode(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The input image to transform')
    model: types.HFRealESRGAN | GraphNode | tuple[GraphNode, str] = Field(default=types.HFRealESRGAN(type='hf.real_esrgan', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The RealESRGAN model to use for image super-resolution')
...
class StableDiffusionControlNetImg2ImgNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionBaseNode.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler
    ...
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionBaseNode.StableDiffusionScheduler = Field(default=nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionBaseNode.StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[types.HFLoraSDConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
    ip_adapter_model: types.HFIPAdapter | GraphNode | tuple[GraphNode, str] = Field(default=types.HFIPAdapter(type='hf.ip_adapter', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The IP adapter model to use for image processing')
    ip_adapter_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided the image will be fed into the IP adapter')
    ...
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler = Field(default=nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The input image to be transformed.')
    strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.5, description='Similarity to the input image')
    controlnet: types.HFControlNet | GraphNode | tuple[GraphNode, str] = Field(default=types.HFControlNet(type='hf.controlnet', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The ControlNet model to use for guidance.')
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The control image to guide the transformation.')
...
class StableDiffusionControlNetInpaintNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionBaseNode.StableDiffusionScheduler
    StableDiffusionUpscaler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler
    StableDiffusionControlNetModel: typing.ClassVar[type] = nodetool.nodes.huggingface.image_to_image.StableDiffusionControlNetModel
    model: types.HFStableDiffusion | GraphNode | tuple[GraphNode, str] = Field(default=types.HFStableDiffusion(type='hf.stable_diffusion', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model to use for image generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='(blurry, low quality, deformed, mutated, bad anatomy, extra limbs, bad proportions, text, watermark, grainy, pixelated, disfigured face, missing fingers, cropped image, bad lighting', description='The negative prompt to guide what should not appear in the generated image.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator. Use -1 for a random seed.')
    ...
    enable_cpu_offload: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable CPU offload for the pipeline. This can reduce VRAM usage.')
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler = Field(default=nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
    controlnet: nodetool.nodes.huggingface.image_to_image.StableDiffusionControlNetModel = Field(default=nodetool.nodes.huggingface.image_to_image.StableDiffusionControlNetModel.INPAINT, description='The ControlNet model to use for guidance.')
    init_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The initial image to be inpainted.')
    mask_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The mask image indicating areas to be inpainted.')
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The control image to guide the inpainting process.')
...
class StableDiffusionControlNetNode(GraphNode):
    ...
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler = Field(default=nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
    controlnet: types.HFControlNet | GraphNode | tuple[GraphNode, str] = Field(default=types.HFControlNet(type='hf.controlnet', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The ControlNet model to use for guidance.')
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The control image to guide the generation process.')
...
class StableDiffusionImg2ImgNode(GraphNode):
    ...
    enable_cpu_offload: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable CPU offload for the pipeline. This can reduce VRAM usage.')
    upscaler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler = Field(default=nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionUpscaler.NONE, description='The upscaler to use for 2-pass generation.')
    init_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The initial image for Image-to-Image generation.')
...
class StableDiffusionUpscale(GraphNode):
    ...
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Guidance scale for generation.')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The initial image for Image-to-Image generation.')
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionBaseNode.StableDiffusionScheduler = Field(default=nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionBaseNode.StableDiffusionScheduler.HeunDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Seed for the random number generator. Use -1 for a random seed.')
...
class StableDiffusionXLControlNetNode(GraphNode):
    ...
    StableDiffusionScheduler: typing.ClassVar[type] = nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLBase.StableDiffusionScheduler
    model: types.HFStableDiffusionXL | GraphNode | tuple[GraphNode, str] = Field(default=types.HFStableDiffusionXL(type='hf.stable_diffusion_xl', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The Stable Diffusion XL model to use for generation.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The prompt for image generation.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='The negative prompt to guide what should not appear in the generated image.')
    ...
    scheduler: nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLBase.StableDiffusionScheduler = Field(default=nodetool.nodes.huggingface.stable_diffusion_base.StableDiffusionXLBase.StableDiffusionScheduler.EulerDiscreteScheduler, description='The scheduler to use for the diffusion process.')
    loras: list[types.HFLoraSDXLConfig] | GraphNode | tuple[GraphNode, str] = Field(default=[], description='The LoRA models to use for image processing')
...
class StableDiffusionXLInpainting(GraphNode):
    ...
    enable_tiling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable tiling for the VAE. This can reduce VRAM usage.')
    enable_cpu_offload: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Enable CPU offload for the pipeline. This can reduce VRAM usage.')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The initial image to be inpainted.')
    mask_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The mask image indicating areas to be inpainted.')
    strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.8, description='Strength for inpainting. Higher values allow for more deviation from the original image.')
...
class Swin2SR(GraphNode):
    ...
    model: types.HFImageToImage | GraphNode | tuple[GraphNode, str] = Field(default=types.HFImageToImage(type='hf.image_to_image', repo_id='', path=None, allow_patterns=None, ignore_patterns=None), description='The model ID to use for image super-resolution')
