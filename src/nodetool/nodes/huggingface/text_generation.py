...
class TextGeneration(HuggingFacePipelineNode):
    ...
    def get_recommended_models(cls) -> list[HFTextGeneration]:
        return [
            ...
            # Qwen 3.5 / 3.6 — current Qwen generation
            HFTextGeneration(repo_id="Qwen/Qwen3.6-27B"),
            HFTextGeneration(repo_id="Qwen/Qwen3.6-35B-A3B"),
            HFTextGeneration(repo_id="Qwen/Qwen3.5-0.8B"),
            HFTextGeneration(repo_id="Qwen/Qwen3.5-2B"),
            HFTextGeneration(repo_id="Qwen/Qwen3.5-4B"),
            HFTextGeneration(repo_id="Qwen/Qwen3.5-9B"),
            HFTextGeneration(repo_id="Qwen/Qwen3.5-27B"),
            HFTextGeneration(repo_id="Qwen/Qwen3.5-35B-A3B"),
